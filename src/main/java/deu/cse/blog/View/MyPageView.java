 ...
 * @author a4424
 */
public class MyPageView extends javax.swing.JFrame {

    /**
     * Creates new form MyPageView
     */
    public MyPageView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MyPageView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
